function growthRateCurveStudy_CORAL()
% Can we do a growth curve for coral (the original plot was for symbionts)?
% Growth constants are con.G (or separately, Gm and Gb).
