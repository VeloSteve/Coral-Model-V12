...
MapGeneration(Reefs_latlon, typSST2050, 2, "RCP 4.5 Hottest month in 2050");

% Delta 2050-historical
dt = typSST2050-typSST1900;
MapGeneration(Reefs_latlon, dt, 3, "RCP 4.5 Hottest Month SST change from 1861-1900 to 2050", 4);
