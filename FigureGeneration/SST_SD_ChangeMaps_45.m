...
MapGeneration(Reefs_latlon, sdSST1900, 1, "RCP 4.5 Standard deviation of SST, 1861-1900", 3);

% Same for 2050 to 2080
SST2050 = SST(:, yearStart(2050):yearEnd(2080));
sdSST2050 = std(SST2050, 0, 2);
MapGeneration(Reefs_latlon, sdSST2050, 2, "RCP 4.5 Standard deviation of SST, 2050-2080", 3);

% Delta 2050-historical
dt = sdSST2050-sdSST1900;
MapGeneration(Reefs_latlon, dt, 3, "RCP 4.5 Difference in SD from 1861-1900 to 2050-2080", 1);
