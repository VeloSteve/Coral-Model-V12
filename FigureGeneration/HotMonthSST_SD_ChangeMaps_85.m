...
%MapGeneration(Reefs_latlon, sdSST1900, 21, "RCP 8.5 - Hottest Month std[SST] 1861-1900", 2);

% Same for 2050 to 2080
SST2050 = SST(:, yearStart(2050):yearEnd(2080));
SST2050 = hottest(SST2050);
sdSST2050 = std(SST2050, 0, 2);
MapGeneration(Reefs_latlon, sdSST2050, 22, "RCP 8.5 - Hottest Month std[SST] 2050-2080", [0 0.8]);

% Delta 2050-historical
dt = sdSST2050-sdSST1900;
%MapGeneration(Reefs_latlon, dt, 23, "RCP 8.5 - \Delta Hottest Month std[SST] 1861-1900 to 2050-2080", [0 0.4]);
MapGeneration(Reefs_latlon, dt, 23, "RCP 8.5 - \Delta Hottest Month std[SST] 1861-1900 to 2050-2080", [-0.2 0.4]);

% Same data, change scale
%MapGeneration(Reefs_latlon, dt, 24, "RCP 8.5 - \Delta Hottest Month std[SST] 1861-1900 to 2050-2080", 0.2);
