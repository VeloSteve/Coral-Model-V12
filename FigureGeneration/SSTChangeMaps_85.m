...
% Same for just 2050.
SST2050 = SST(:, yearStart(2050):yearEnd(2050));
% Reshape to have groups of 12 (second index is 12 months of a year)
...
MapGeneration(Reefs_latlon, dt, 3, "RCP 8.5 Hottest Month SST change from 1861-1900 to 2050", 4);
...
MapGeneration(Reefs_latlon, dtFlag, 4, "RCP 8.5 10% Largest and Smallest Changes");
