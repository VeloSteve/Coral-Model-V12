...
%MapGeneration(Reefs_latlon, sdSST1900, 4, "RCP 8.5 - All months std[SST] 1861-1900", 3);

% Same for 2050 to 2080
SST2050 = SST(:, yearStart(2050):yearEnd(2080));
sdSST2050 = std(SST2050, 0, 2);
MapGeneration(Reefs_latlon, sdSST2050, 5, "RCP 8.5 All months std[SST] 2050-2080", [0 4]);

% Delta 2050-historical
dt = sdSST2050-sdSST1900;
MapGeneration(Reefs_latlon, dt, 6, "RCP 8.5 All months \Delta std[SD] from 1861-1900 to 2050-2080", [-0.2 0.6]);
