...
function [propTest] = getPropTest(E, RCP, superMode, advantage, startYear, bleachTarget)
    ...
    propCases = NaN(50, 6);
    propCases(20, :) = [0, 26, 0, 0, 0, 5];
    propCases(24, :) = [0, 45, 0, 0, 0, 5];
    propCases(25, :) = [0, 60, 0, 0, 0, 5];
    propCases(21, :) = [0, 85, 0, 0, 0, 5];
    propCases(22, :) = [1, 26, 0, 0, 0, 5];
    propCases(26, :) = [1, 45, 0, 0, 0, 5];
    propCases(27, :) = [1, 60, 0, 0, 0, 5];
    propCases(23, :) = [1, 85, 0, 0, 0, 5];
    
    propCases(2, :) = [0, 26, 0, 0, 0, 10];
    propCases(4, :) = [0, 45, 0, 0, 0, 10];
    propCases(6, :) = [0, 60, 0, 0, 0, 10];
    propCases(8, :) = [0, 85, 0, 0, 0, 10];
    propCases(3, :) = [1, 26, 0, 0, 0, 10];
    propCases(5, :) = [1, 45, 0, 0, 0, 10];
    propCases(7, :) = [1, 60, 0, 0, 0, 10];
    propCases(9, :) = [1, 85, 0, 0, 0, 10];
    
    propCases(10, :) = [0, 26, 0, 0, 0, 3];
    propCases(12, :) = [0, 45, 0, 0, 0, 3];
    propCases(14, :) = [0, 60, 0, 0, 0, 3];
    propCases(16, :) = [0, 85, 0, 0, 0, 3];
    propCases(11, :) = [1, 26, 0, 0, 0, 3];
    propCases(13, :) = [1, 45, 0, 0, 0, 3];
    propCases(15, :) = [1, 60, 0, 0, 0, 3];
    propCases(17, :) = [1, 85, 0, 0, 0, 3];
    
    % Start including shuffling cases.  Note that the order of entry is
    % different here, but of course it doesn't matter.
    propCases(28, :) = [0, 26, 9, 1.0, 1861, 5];  % RCP 2.6, E=0
    propCases(29, :) = [1, 26, 9, 1.0, 1861, 5];  % RCP 2.6, E=1
    propCases(30, :) = [0, 45, 9, 1.0, 1861, 5];  % RCP 4.5, E=0
    propCases(31, :) = [1, 45, 9, 1.0, 1861, 5];  % RCP 4.5, E=1
    propCases(32, :) = [0, 60, 9, 1.0, 1861, 5];  % RCP 6.0, E=0
    propCases(33, :) = [1, 60, 9, 1.0, 1861, 5];  % RCP 6.0, E=1
    propCases(34, :) = [0, 85, 9, 1.0, 1861, 5];  % RCP 8.5, E=0
    propCases(35, :) = [1, 85, 9, 1.0, 1861, 5];  % RCP 8.5, E=1

    % Shuffling, but with advantage = 1.5C
    propCases(36, :) = [1, 26, 9, 1.5, 1861, 5];  % RCP 8.5, E=1
    ...
    yyy = propCases(:, 5) == startYear;
    bbb = propCases(:, 6) == bleachTarget;
    propTest = find(eee & rrr & sss & aaa & yyy & bbb);
    if size(propTest) > 1
        error('propTest is not uniquely specified by E = %d, RCP = %s, superMode = %d, advantage = %d, startYear = %d, bleachTarget = %d', ...
            E, RCP, superMode, advantage, startYear, bleachTarget);
    elseif size(propTest) == 0 | propTest == 0
            error('propTest is not defined for E = %d, RCP = %s, superMode = %d, advantage = %d, startYear = %d, bleachTarget = %d', ...
            E, RCP, superMode, advantage, startYear, bleachTarget);
    end
    return;
end
